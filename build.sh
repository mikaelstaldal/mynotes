...
#    demo-backend, and logo-drift tests.
run node --import ./web/ts/test-preload.mjs --test web/ts/xss-gate.test.mjs web/ts/markdown.test.mjs web/ts/tasks.test.mjs web/ts/basepath.test.mjs web/ts/email.test.mjs web/ts/publish.test.mjs web/ts/mymail.test.mjs web/ts/render-kit.test.mjs web/ts/htmlmd.test.mjs web/ts/demo.test.mjs web/ts/logo.test.mjs
