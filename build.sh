...
# 5. Run frontend XSS-gate, markdown render, subpath-deployment, email-body,
#    MyMail-URL, render-kit wiring, HTML-import, and demo-backend tests.
run node --import ./web/ts/test-preload.mjs --test web/ts/xss-gate.test.mjs web/ts/markdown.test.mjs web/ts/basepath.test.mjs web/ts/email.test.mjs web/ts/mymail.test.mjs web/ts/render-kit.test.mjs web/ts/htmlmd.test.mjs web/ts/demo.test.mjs
